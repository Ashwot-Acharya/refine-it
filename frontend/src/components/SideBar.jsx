   ...
   <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      ...
      <li>
            <a href="/" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <img src={vite} className ="w-10"alt="" srcset="" />
               <span className="flex-1 ms-3 whitespace-nowrap">ReFineIT</span>
            </a>
         </li>
         <li>
            <a href="/dashboard" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="ms-3 items-center">Dashboard</span>
            </a>
         </li>
         <li>
            <a href="/finder" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  
               <span className="ms-3 items-center">Paper Search</span>
            </a>
         </li>
